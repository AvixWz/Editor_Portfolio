  ...
  const projects: Project[] = [
    {
      ...
      image: 'dist/assets/henry.jpg',
      link: 'https://youtu.be/2MTST0bEkP0?si=8mpxzCtPh2TGXvvF',
      featured: true,
      year: '2024',
    },
    {
    ...
    <div className="pt-24 pb-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="text-center mt-20 p-8 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl"
        >
